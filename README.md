...
Task: Creating and Analysing a simulated financial behaviour of a user
...
Skills:
- Creation of a randomly generated dataset
- Combination use of SQL and Python

Featuring Analysis such as
- Mean amount spent per month
- Highest Spending Days
- Genre in which the most money was spent
